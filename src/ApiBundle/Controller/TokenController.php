...
class TokenController extends \FOS\OAuthServerBundle\Controller\TokenController {
     ...
     * parameters={
     *      {"name"="grant_type", "dataType"="string", "required"=true, "description"="'client_credentials' o 'password'"},
     ...
     *      {"name"="username", "dataType"="string", "required"=false, "description"="(Solo para grant_type=password) Nombre de usuario"},
     *      {"name"="password", "dataType"="string", "required"=false, "description"="(Solo para grant_type=password) Contraseña"},
     *  },
     * resource=true,
